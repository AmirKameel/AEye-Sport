...
pages = ["Home", "Talent", "Player", "Team", "A_Eye"]
...
def analyze_performance(file_path, position, player_name, player_image_path):
    try:
        ...
        prompt = f"You are a scout for a top football club, evaluating young talents based on their attacking statistics or deffencing statistics or passing statistics. Given the player position {position}, assess whether they are a promising talent and justify your evaluation. If the player is deemed talented, create a professional profile summarizing their key strengths and potential for future development. based on his stats here is \n"      
...
# Page title
st.markdown("<h1 class='section-title'>Scouting Young Talents</h1>", unsafe_allow_html=True)
